...
const sectionLabel = item => sections[item.section]?.label || "第 17 課";
...
$("#reset-vocabulary").onclick = () => { if(confirm("清除全部 152 詞的記憶卡進度、答題標記和收藏？")){state=structuredClone(defaults);renderCard();} };
